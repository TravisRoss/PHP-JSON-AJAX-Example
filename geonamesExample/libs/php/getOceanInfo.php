<?php
	...
	$url='api.geonames.org/oceanJSON?&lat=' . $_REQUEST['latitude'] . '&lng=' . $_REQUEST['longtitude'] . '&username=travyalonso';
	...
	$output['data'] = $decode['ocean']; //just take the geonames object
